...
label start:
    ...
    $ s3_li = "Bill"
    $ s3_mc.past_partners = ["Bill", "Harry"]
    $ s3_mc.bff = "Seb"
    $ s3_mc.job = "Athlete"
    $ s3_mc.bisexual = False
    $ s3_mc.diet = "Vegetarian"
    $ s3_mc.like_mc = {"Bill":10, "Camilo":5, "Harry":15, "AJ":5, "Elladine":15, 
            "Iona":5, "Genevieve":5, "Miki":5, "Nicky":5, "Seb":15,
            "Yasmin":5, "Ciaran":5, "Tai":10}
